...
#define MAX_PLAYER_NAME          40                         // max allowed by client name length
#define MAX_INTERNAL_PLAYER_NAME 43                         // max server internal player name length (> MAX_PLAYER_NAME for support declined names)
