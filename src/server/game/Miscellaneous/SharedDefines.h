...
#define RACEMASK_ALL_PLAYABLE                     \
    ((UI64LIT(1)<<(RACE_HUMAN-1))               | \
     ...
     (UI64LIT(1)<<(RACE_FEL_ORC-1))             | \
     (UI64LIT(1)<<(RACE_NAGA-1))                | \
     (UI64LIT(1)<<(RACE_BROKEN-1))              | \
     (UI64LIT(1)<<(RACE_SKELETON-1))            | \
     (UI64LIT(1)<<(RACE_VRYKUL-1))              | \
     (UI64LIT(1)<<(RACE_TUSKARR-1))             | \
     (UI64LIT(1)<<(RACE_FOREST_TROLL-1))        | \
     (UI64LIT(1)<<(RACE_TAUNKA-1))              | \
     (UI64LIT(1)<<(RACE_NORTHREND_SKELETON-1))  | \
     (UI64LIT(1)<<(RACE_ICE_TROLL-1))           | \
