...
//                                      = 752, see LANG_PINFO_ACC_IP
    ...
    LANG_TICKET_CANCEL_BY_PLAYERS                 = 90030,
    LANG_TICKET_CLOSED_BY_GAMEMASTERS             = 90031,
    LANG_TICKET_SEND_NOTIF_CLOSED                 = 90032,
    LANG_TICKET_SEND_NOTFI_CANCEL                 = 90033,
    LANG_TICKET_NOTFOUND                          = 90034,
    LANG_TICKET_ALREADY_CANCEL                    = 90035,
    LANG_TICKET_RESULT_GM_QUERY                   = 90036,
    LANG_TICKET_RESULT_NONE_GM                    = 90037,
    LANG_TICKET_RESULT_PLAYER_QUERY               = 90038,
    LANG_TICKET_RESULT_NONE_PLAYER                = 90039,

    //PHASE_DELETE
    LANG_PHASE_INVITE_DEL_OWNER                   = 90040,
    LANG_PHASE_INVITE_DEL_TARGET                  = 90041,

    // PHASE SET OWNER
    LANG_PHASE_INVITE_OWNER                       = 90042,
    LANG_PHASE_INVITE_OWNER_TARGET                = 90043,
    LANG_PHASE_DEL_OWNER                          = 90044,
    LANG_PHASE_DEL_OWNER_TARGET                   = 90045,
    ...
    // GOBJECT DUPPLICATION

    // LOOKUP
    LANG_DUPPLICATION_LOOKUP_ERROR                = 91000,
    LANG_DUPPLICATION_LOOKUP_SUCCESS              = 91001,

    // CREATE
    LANG_DUPPLICATION_CREATE_RANGE_ERR_FAR        = 91002,
    LANG_DUPPLICATION_CREATE_RANGE_ERR_DOODADS    = 91003,
    LANG_DUPPLICATION_CREATE_SUCCESS              = 91004,
    LANG_DUPPLICATION_CREATE_NAME_LONG            = 91020,

    // ADD
    LANG_DUPPLICATION_ADD_ERROR                   = 91005,
    LANG_DUPPLICATION_ADD_PRIVATE                 = 91006,
    LANG_DUPPLICATION_ADD_SUCCESS                 = 91007,

    // TARGET
    LANG_DUPPLICATION_TARGET_ERROR                = 91008,
    LANG_DUPPLICATION_TARGET_EMPTY                = 91009,
    LANG_DUPPLICATION_TARGET_FAR                  = 91010,
    LANG_DUPPLICATION_TARGET_CLOSE                = 91011,
    LANG_DUPPLICATION_TARGET_HERE                 = 91012,
    LANG_DUPPLICATION_TARGET_SUCCESS              = 91013,

    // DELETE
    LANG_DUPPLICATION_DELETE_SUCCESS              = 91014,
    LANG_DUPPLICATION_DELETE_ERROR                = 91015,

    // PRIVATE
    LANG_DUPPLICATION_PRIVATE_ON                  = 91016,
    LANG_DUPPLICATION_PRIVATE_OFF                 = 91017,

    // REMOVE
    LANG_DUPPLICATION_REMOVE_SUCCESS              = 91018,

    // GENERAL
    LANG_DUPPLICATION_ERROR_OR_PRIVATE            = 91019,
