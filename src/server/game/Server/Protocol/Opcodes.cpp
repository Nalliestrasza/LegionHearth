...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_LOOT_ROLL,                                          STATUS_UNHANDLED,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootRoll); // deactivate because crash
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AURORA_ZONE_CUSTOM_DELETE,               STATUS_NEVER,        CONNECTION_TYPE_INSTANCE);
