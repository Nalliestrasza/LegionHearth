...
public:
    ...
    static bool HandlePhaseSkyboxCommand(ChatHandler* handler, char const* args)
    {
        ...
        // On contr��si le joueur poss褥 une entr饠dans la base de donn饠qui contient les settings perma (morph, etc..)
        ...
        // Si le joueur est dans une phase, on envoit le packet ࠴ous les joueurs pr鳥nt dans la phase, sinon qu'ࠬui-mꭥ.
        if (player->GetMapId() >= 5000)
